...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS db_SaudeMenos.Pessoal_de_apoio (
  CPF CHAR(11) NOT NULL,
  Nome VARCHAR(90) NOT NULL,
  Matricula_UN INT NOT NULL AUTO_INCREMENT,
  NomeSocial VARCHAR(90) NULL,
  ...
  PRIMARY KEY (CPF),
  UNIQUE INDEX Email_UNIQUE (Email ASC) VISIBLE,
  INDEX fk_Pessoal_de_apoio_Ambulatorios1_idx (Ambulatorios_id_ambulatorio ASC, Ambulatorios_Hospitais_CNES1 ASC) VISIBLE,
  INDEX fk_Pessoal_de_apoio_Endereco1_idx (Endereco_id_endereco ASC) VISIBLE,
  INDEX fk_Pessoal_de_apoio_Telefone1_idx (Telefone_num_telefone ASC, Telefone_DDD ASC) VISIBLE,
  CONSTRAINT fk_Pessoal_de_apoio_Ambulatorios
    FOREIGN KEY (Ambulatorios_id_ambulatorio , Ambulatorios_Hospitais_CNES1)
    REFERENCES db_SaudeMenos.Ambulatorios (id_ambulatorio , Hospitais_CNES)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_Pessoal_de_apoio_Endereco
    FOREIGN KEY (Endereco_id_endereco)
    REFERENCES db_SaudeMenos.Endereco (id_endereco)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_Pessoal_de_apoio_Telefone
    FOREIGN KEY (Telefone_num_telefone , Telefone_DDD)
    REFERENCES db_SaudeMenos.Telefone (num_telefone , DDD)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
